...
export const WaterBottleIcon = ({ className = "w-4 h-4" }: { className?: string }) => (
  <svg 
    className={className} 
    viewBox="0 0 24 24" 
    fill="none" 
    ...
    strokeWidth="2"
  >
    <path d="M9 3h6v4h3v12H6V7h3V3z" />
    <path d="M9 7h6" />
    <path d="M12 11v6" />
  </svg>
)

export const DeliveryTruckIcon = ({ className = "w-4 h-4" }: { className?: string }) => (
  <svg 
    className={className} 
    viewBox="0 0 24 24" 
    fill="none" 
  ...
  >
    ...
    <path d="M20 17h2v4h-2z" />
    <path d="M2 17h2v4H2z" />
    <path d="M18 17h-4v-6h6l2 4v2h-4" />
    <path d="M4 17h10v-6H4v6z" />
    <path d="M14 5h4l2 2v4" />
  </svg>
)
...
export const AddCustomerIcon = ({ className = "w-4 h-4" }: { className?: string }) => (
  <svg 
    className={className} 
    viewBox="0 0 24 24" 
    fill="none" 
